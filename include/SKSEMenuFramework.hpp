...
inline HMODULE GetSKSEMenuFrameworkModule() {
    static HMODULE menuFramework = nullptr;
    if (!menuFramework) {
        menuFramework = GetModuleHandleA("SKSEMenuFramework.dll");
    }
    if (!menuFramework) {
        menuFramework = GetModuleHandleA("SKSEMenuFramework");
    }
    return menuFramework;
}

#define menuFramework GetSKSEMenuFrameworkModule()

namespace ImGuiMCP {
    using ImVec2 = struct ImVec2;
    ...
    namespace Model {
        namespace Internal {
            ...
            T GetFunction(LPCSTR name) {
                const auto module = GetSKSEMenuFrameworkModule();
        ...
        using AddWindowFunction = WindowInterface* (*)(RenderFunction);
        using GetMainWindowFunction = WindowInterface* (*)();
...
#define IM_COL32_BLACK_TRANS IM_COL32(0, 0, 0, 0)    // Transparent black = 0x00000000
    ...
    using ImDrawChannel = struct ImDrawChannel;
    using ImDrawCmd = struct ImDrawCmd;
    using ImDrawData = struct ImDrawData;
    using ImDrawList = struct ImDrawList;
    using ImDrawListSharedData = struct ImDrawListSharedData;
    using ImDrawListSplitter = struct ImDrawListSplitter;
    using ImDrawVert = struct ImDrawVert;
    using ImFont = struct ImFont;
    using ImFontAtlas = struct ImFontAtlas;
    using ImFontBuilderIO = struct ImFontBuilderIO;
    using ImFontConfig = struct ImFontConfig;
    using ImFontGlyph = struct ImFontGlyph;
    using ImFontGlyphRangesBuilder = struct ImFontGlyphRangesBuilder;
    using ImColor = struct ImColor;
    using ImGuiContext = struct ImGuiContext;
    using ImGuiIO = struct ImGuiIO;
    using ImGuiInputTextCallbackData = struct ImGuiInputTextCallbackData;
    using ImGuiKeyData = struct ImGuiKeyData;
    using ImGuiListClipper = struct ImGuiListClipper;
    using ImGuiOnceUponAFrame = struct ImGuiOnceUponAFrame;
    using ImGuiPayload = struct ImGuiPayload;
    using ImGuiPlatformIO = struct ImGuiPlatformIO;
    using ImGuiPlatformMonitor = struct ImGuiPlatformMonitor;
    using ImGuiPlatformImeData = struct ImGuiPlatformImeData;
    using ImGuiSizeCallbackData = struct ImGuiSizeCallbackData;
    using ImGuiStorage = struct ImGuiStorage;
    using ImGuiStyle = struct ImGuiStyle;
    using ImGuiTableSortSpecs = struct ImGuiTableSortSpecs;
    using ImGuiTableColumnSortSpecs = struct ImGuiTableColumnSortSpecs;
    using ImGuiTextBuffer = struct ImGuiTextBuffer;
    using ImGuiTextFilter = struct ImGuiTextFilter;
    using ImGuiViewport = struct ImGuiViewport;
    using ImGuiWindowClass = struct ImGuiWindowClass;
    using ImBitVector = struct ImBitVector;
    using ImRect = struct ImRect;
    using ImDrawDataBuilder = struct ImDrawDataBuilder;
    using ImGuiColorMod = struct ImGuiColorMod;
    using ImGuiContextHook = struct ImGuiContextHook;
    using ImGuiDataVarInfo = struct ImGuiDataVarInfo;
    using ImGuiDataTypeInfo = struct ImGuiDataTypeInfo;
    using ImGuiDockContext = struct ImGuiDockContext;
    using ImGuiDockRequest = struct ImGuiDockRequest;
    using ImGuiDockNode = struct ImGuiDockNode;
    using ImGuiDockNodeSettings = struct ImGuiDockNodeSettings;
    using ImGuiGroupData = struct ImGuiGroupData;
    using ImGuiInputTextState = struct ImGuiInputTextState;
    using ImGuiInputTextDeactivateData = struct ImGuiInputTextDeactivateData;
    using ImGuiLastItemData = struct ImGuiLastItemData;
    using ImGuiLocEntry = struct ImGuiLocEntry;
    using ImGuiMenuColumns = struct ImGuiMenuColumns;
    using ImGuiNavItemData = struct ImGuiNavItemData;
    using ImGuiNavTreeNodeData = struct ImGuiNavTreeNodeData;
    using ImGuiMetricsConfig = struct ImGuiMetricsConfig;
    using ImGuiNextWindowData = struct ImGuiNextWindowData;
    using ImGuiNextItemData = struct ImGuiNextItemData;
    using ImGuiOldColumnData = struct ImGuiOldColumnData;
    using ImGuiOldColumns = struct ImGuiOldColumns;
    using ImGuiPopupData = struct ImGuiPopupData;
    using ImGuiSettingsHandler = struct ImGuiSettingsHandler;
    using ImGuiStackSizes = struct ImGuiStackSizes;
    using ImGuiStyleMod = struct ImGuiStyleMod;
    using ImGuiTabBar = struct ImGuiTabBar;
    using ImGuiTabItem = struct ImGuiTabItem;
    using ImGuiTable = struct ImGuiTable;
    using ImGuiTableHeaderData = struct ImGuiTableHeaderData;
    using ImGuiTableColumn = struct ImGuiTableColumn;
    using ImGuiTableInstanceData = struct ImGuiTableInstanceData;
    using ImGuiTableTempData = struct ImGuiTableTempData;
    using ImGuiTableSettings = struct ImGuiTableSettings;
    using ImGuiTableColumnsSettings = struct ImGuiTableColumnsSettings;
    using ImGuiTypingSelectState = struct ImGuiTypingSelectState;
    using ImGuiTypingSelectRequest = struct ImGuiTypingSelectRequest;
    using ImGuiWindow = struct ImGuiWindow;
    using ImGuiWindowDockStyle = struct ImGuiWindowDockStyle;
    using ImGuiWindowTempData = struct ImGuiWindowTempData;
    using ImGuiWindowSettings = struct ImGuiWindowSettings;
    using ImVector_const_charPtr = struct ImVector_const_charPtr {
        int Size;
        int Capacity;
        const char** Data;
    };
    ...
    using ImS8 = signed char;
    using ImU8 = unsigned char;
    using ImS16 = signed short;
    using ImU16 = unsigned short;
    using ImS32 = signed int;
    using ImU32 = unsigned int;
    using ImS64 = signed long long;
    ...
    using ImGuiTableBgTarget = int;
    using ImDrawFlags = int;
    using ImDrawListFlags = int;
    using ImFontAtlasFlags = int;
    ...
    using ImVec4 = struct ImVec4;

    struct ImVec4 {
        float x, y, z, w;
    };

    using ImGuiWindowFlags_ = enum {
    ...
    using ImGuiInputTextFlags_ = enum {
    ...
    using ImGuiTreeNodeFlags_ = enum {
    ...
    using ImGuiSelectableFlags_ = enum {
    ...
    using ImGuiDockNodeFlags_ = enum {
    ...
    using ImGuiDragDropFlags_ = enum {
    ...
    using ImGuiColorEditFlags_ = enum {
    ...
    using ImGuiMouseButton_ = enum {
        ImGuiMouseButton_Left = 0,
        ImGuiMouseButton_Right = 1,
        ImGuiMouseButton_Middle = 2,
        ImGuiMouseButton_COUNT = 5
    };
    using ImGuiMouseCursor_ = enum {
    ...
    using ImGuiMouseSource = enum {
        ImGuiMouseSource_Mouse = 0,
        ImGuiMouseSource_TouchScreen = 1,
        ImGuiMouseSource_Pen = 2,
        ImGuiMouseSource_COUNT = 3,
    };
    using ImGuiCond_ = enum {
        ImGuiCond_None = 0,
    ...
    using ImGuiTableColumnFlags_ = enum {
    ...
    using ImGuiTableRowFlags_ = enum {
        ImGuiTableRowFlags_None = 0,
        ImGuiTableRowFlags_Headers = 1 << 0,
    };
    using ImGuiTableBgTarget_ = enum {
    ...
    using ImVector_ImWchar = struct ImVector_ImWchar {
        int Size;
        int Capacity;
        ImWchar* Data;
    };
    ...
    using ImGuiTextRange = struct ImGuiTextRange;

    using ImVector_ImGuiTextRange = struct ImVector_ImGuiTextRange {
        int Size;
        int Capacity;
        ImGuiTextRange* Data;
    };
    ...
    class ImGuiTextFilter {
        ...
        static Data* Create(const char* default_filter) {
    ...
    using ImGuiTextRange = struct ImGuiTextRange;
    using ImVector_char = struct ImVector_char {
        int Size;
        int Capacity;
        char* Data;
    };
    ...
    using ImGuiStoragePair = struct ImGuiStoragePair;

    using ImVector_ImGuiStoragePair = struct ImVector_ImGuiStoragePair {
        int Size;
        int Capacity;
    ...
    using ImDrawCallback = void (*)(const ImDrawList* parent_list, const ImDrawCmd* cmd);
    ...
    using ImDrawCmdHeader = struct ImDrawCmdHeader;
    ...
    using ImVector_ImDrawCmd = struct ImVector_ImDrawCmd {
        int Size;
        int Capacity;
        ImDrawCmd* Data;
    };

    using ImVector_ImDrawIdx = struct ImVector_ImDrawIdx {
        int Size;
        int Capacity;
        ImDrawIdx* Data;
    };
    ...
    using ImVector_ImDrawChannel = struct ImVector_ImDrawChannel {
        int Size;
        int Capacity;
        ImDrawChannel* Data;
    };
    ...
    using ImVector_ImDrawVert = struct ImVector_ImDrawVert {
        int Size;
        int Capacity;
        ImDrawVert* Data;
    };

    using ImVector_ImVec2 = struct ImVector_ImVec2 {
        int Size;
        int Capacity;
        ImVec2* Data;
    };

    using ImVector_ImVec4 = struct ImVector_ImVec4 {
        int Size;
        int Capacity;
        ImVec4* Data;
    };

    using ImVector_ImTextureID = struct ImVector_ImTextureID {
        int Size;
        int Capacity;
        ImTextureID* Data;
    };
    ...
    using ImVector_ImDrawListPtr = struct ImVector_ImDrawListPtr {
        int Size;
        int Capacity;
        ImDrawList** Data;
    };
    ...
    using ImVector_ImU32 = struct ImVector_ImU32 {
        int Size;
        int Capacity;
        ImU32* Data;
    };
    ...
    using ImFontAtlasCustomRect = struct ImFontAtlasCustomRect;
    ...
    using ImFontAtlasFlags_ = enum {
        ImFontAtlasFlags_None = 0,
        ImFontAtlasFlags_NoPowerOfTwoHeight = 1 << 0,
        ImFontAtlasFlags_NoMouseCursors = 1 << 1,
        ImFontAtlasFlags_NoBakedLines = 1 << 2,
    };
    using ImVector_ImFontPtr = struct ImVector_ImFontPtr {
        int Size;
        int Capacity;
        ImFont** Data;
    };

    using ImVector_ImFontAtlasCustomRect = struct ImVector_ImFontAtlasCustomRect {
        int Size;
        int Capacity;
        ImFontAtlasCustomRect* Data;
    };

    using ImVector_ImFontConfig = struct ImVector_ImFontConfig {
        int Size;
        int Capacity;
        ImFontConfig* Data;
    };
    ...
    using ImVector_float = struct ImVector_float {
        int Size;
        int Capacity;
        float* Data;
    };

    using ImVector_ImFontGlyph = struct ImVector_ImFontGlyph {
        int Size;
        int Capacity;
        ImFontGlyph* Data;
    };
    ...
    using ImGuiViewportFlags_ = enum {
    ...
    using ImVector_ImGuiPlatformMonitor = struct ImVector_ImGuiPlatformMonitor {
        int Size;
        int Capacity;
        ImGuiPlatformMonitor* Data;
    };

    using ImVector_ImGuiViewportPtr = struct ImVector_ImGuiViewportPtr {
        int Size;
        int Capacity;
        ImGuiViewport** Data;
    };
    ...
    using ImGuiDataAuthority = int;
    using ImGuiLayoutType = int;
    using ImGuiActivateFlags = int;
    using ImGuiDebugLogFlags = int;
    using ImGuiFocusRequestFlags = int;
    using ImGuiItemFlags = int;
    using ImGuiItemStatusFlags = int;
    using ImGuiOldColumnFlags = int;
    using ImGuiNavHighlightFlags = int;
    using ImGuiNavMoveFlags = int;
    using ImGuiNextItemDataFlags = int;
    using ImGuiNextWindowDataFlags = int;
    using ImGuiScrollFlags = int;
    using ImGuiSeparatorFlags = int;
    using ImGuiTextFlags = int;
    using ImGuiTooltipFlags = int;
    using ImGuiTypingSelectFlags = int;
    using ImGuiWindowRefreshFlags = int;
    using ImGuiErrorLogCallback = void (*)(void* user_data, const char* fmt, ...);
    extern ImGuiContext* GImGui;
    using StbUndoRecord = struct StbUndoRecord;
    ...
    using StbUndoState = struct StbUndoState;
    ...
    using STB_TexteditState = struct STB_TexteditState;
    ...
    using StbTexteditRow = struct StbTexteditRow;
    ...
    using ImFileHandle = FILE*;
    using ImVec1 = struct ImVec1;

    struct ImVec1 {
        float x;
    };

    using ImVec2ih = struct ImVec2ih;
    ...
    using ImPoolIdx = int;
    using ImGuiTextIndex = struct ImGuiTextIndex;
    using ImVector_int = struct ImVector_int {
        int Size;
        int Capacity;
        int* Data;
    };
    ...
    using ImGuiDataTypeStorage = struct ImGuiDataTypeStorage;
    ...
    using ImGuiDataTypePrivate_ = enum {
        ImGuiDataType_String = ImGuiDataType_COUNT + 1,
        ImGuiDataType_Pointer,
        ImGuiDataType_ID,
    };
    using ImGuiItemFlags_ = enum {
    ...
    using ImGuiItemStatusFlags_ = enum {
    ...
    using ImGuiHoveredFlagsPrivate_ = enum {
    ...
    using ImGuiInputTextFlagsPrivate_ = enum {
    ...
    using ImGuiButtonFlagsPrivate_ = enum {
    ...
    using ImGuiComboFlagsPrivate_ = enum {
        ImGuiComboFlags_CustomPreview = 1 << 20,
    };
    using ImGuiSliderFlagsPrivate_ = enum {
        ImGuiSliderFlags_Vertical = 1 << 20,
        ImGuiSliderFlags_ReadOnly = 1 << 21,
    };
    using ImGuiSelectableFlagsPrivate_ = enum {
    ...
    using ImGuiTreeNodeFlagsPrivate_ = enum {
        ImGuiTreeNodeFlags_ClipLabelForTrailingButton = 1 << 20,
        ImGuiTreeNodeFlags_UpsideDownArrow = 1 << 21,
    };
    using ImGuiSeparatorFlags_ = enum {
        ImGuiSeparatorFlags_None = 0,
        ImGuiSeparatorFlags_Horizontal = 1 << 0,
        ImGuiSeparatorFlags_Vertical = 1 << 1,
        ImGuiSeparatorFlags_SpanAllColumns = 1 << 2,
    };
    using ImGuiFocusRequestFlags_ = enum {
        ImGuiFocusRequestFlags_None = 0,
        ImGuiFocusRequestFlags_RestoreFocusedChild = 1 << 0,
        ImGuiFocusRequestFlags_UnlessBelowModal = 1 << 1,
    };
    using ImGuiTextFlags_ = enum {
        ImGuiTextFlags_None = 0,
        ImGuiTextFlags_NoWidthForLargeClippedText = 1 << 0,
    };
    using ImGuiTooltipFlags_ = enum {
        ImGuiTooltipFlags_None = 0,
        ImGuiTooltipFlags_OverridePrevious = 1 << 1,
    };
    using ImGuiLayoutType_ = enum { ImGuiLayoutType_Horizontal = 0, ImGuiLayoutType_Vertical = 1 };
    using ImGuiLogType = enum {
        ImGuiLogType_None = 0,
        ImGuiLogType_TTY,
        ImGuiLogType_File,
        ImGuiLogType_Buffer,
    ...
    using ImGuiAxis = enum { ImGuiAxis_None = -1, ImGuiAxis_X = 0, ImGuiAxis_Y = 1 };
    using ImGuiPlotType = enum {
        ImGuiPlotType_Lines,
    ...
    using ImGuiComboPreviewData = struct ImGuiComboPreviewData;
    ...
    using ImGuiInputTextDeactivatedState = struct ImGuiInputTextDeactivatedState;
    ...
    using ImGuiWindowRefreshFlags_ = enum {
    ...
    using ImGuiNextWindowDataFlags_ = enum {
    ...
    using ImGuiSelectionUserData = ImS64;
    using ImGuiNextItemDataFlags_ = enum {
    ...
    using ImGuiWindowStackData = struct ImGuiWindowStackData;
    ...
    using ImGuiShrinkWidthItem = struct ImGuiShrinkWidthItem;
    ...
    using ImGuiPtrOrIndex = struct ImGuiPtrOrIndex;
    ...
    using ImGuiPopupPositionPolicy = enum {
    ...
    using ImBitArray_ImGuiKey_NamedKey_COUNT__lessImGuiKey_NamedKey_BEGIN =
        struct ImBitArray_ImGuiKey_NamedKey_COUNT__lessImGuiKey_NamedKey_BEGIN {
        ImU32 Storage[(ImGuiKey_NamedKey_COUNT + 31) >> 5];
    };

    using ImBitArrayForNamedKeys = ImBitArray_ImGuiKey_NamedKey_COUNT__lessImGuiKey_NamedKey_BEGIN;
    using ImGuiInputEventType = enum {
    ...
    using ImGuiInputEventMousePos = struct ImGuiInputEventMousePos;
    ...
    using ImGuiInputEventMouseWheel = struct ImGuiInputEventMouseWheel;
    ...
    using ImGuiInputEventMouseButton = struct ImGuiInputEventMouseButton;
    ...
    using ImGuiInputEventMouseViewport = struct ImGuiInputEventMouseViewport;

    struct ImGuiInputEventMouseViewport {
        ImGuiID HoveredViewportID;
    };

    using ImGuiInputEventKey = struct ImGuiInputEventKey;
    ...
    using ImGuiInputEventText = struct ImGuiInputEventText;

    struct ImGuiInputEventText {
        unsigned int Char;
    };

    using ImGuiInputEventAppFocused = struct ImGuiInputEventAppFocused;

    struct ImGuiInputEventAppFocused {
        bool Focused;
    };

    using ImGuiInputEvent = struct ImGuiInputEvent;
    ...
    using ImGuiKeyRoutingIndex = ImS16;
    using ImGuiKeyRoutingData = struct ImGuiKeyRoutingData;
    ...
    using ImGuiKeyRoutingTable = struct ImGuiKeyRoutingTable;
    using ImVector_ImGuiKeyRoutingData = struct ImVector_ImGuiKeyRoutingData {
        int Size;
        int Capacity;
    ...
    using ImGuiKeyOwnerData = struct ImGuiKeyOwnerData;
    ...
    using ImGuiInputFlagsPrivate_ = enum {
    ...
    using ImGuiListClipperRange = struct ImGuiListClipperRange;
    ...
    using ImGuiListClipperData = struct ImGuiListClipperData;
    using ImVector_ImGuiListClipperRange = struct ImVector_ImGuiListClipperRange {
        int Size;
        int Capacity;
    ...
    using ImGuiActivateFlags_ = enum {
    ...
    using ImGuiNavHighlightFlags_ = enum {
        ImGuiNavHighlightFlags_None = 0,
        ImGuiNavHighlightFlags_Compact = 1 << 1,
        ImGuiNavHighlightFlags_AlwaysDraw = 1 << 2,
        ImGuiNavHighlightFlags_NoRounding = 1 << 3,
    };
    using ImGuiNavMoveFlags_ = enum {
    ...
    using ImGuiNavLayer = enum { ImGuiNavLayer_Main = 0, ImGuiNavLayer_Menu = 1, ImGuiNavLayer_COUNT };
    ...
    using ImGuiFocusScopeData = struct ImGuiFocusScopeData;
    ...
    using ImGuiTypingSelectFlags_ = enum {
    ...
    using ImGuiOldColumnFlags_ = enum {
    ...
    using ImVector_ImGuiOldColumnData = struct ImVector_ImGuiOldColumnData {
        int Size;
        int Capacity;
    ...
    using ImGuiDockNodeFlagsPrivate_ = enum {
    ...
    using ImGuiDataAuthority_ = enum {
        ImGuiDataAuthority_Auto,
        ImGuiDataAuthority_DockNode,
        ImGuiDataAuthority_Window,
    };
    using ImGuiDockNodeState = enum {
        ImGuiDockNodeState_Unknown,
        ImGuiDockNodeState_HostWindowHiddenBecauseSingleWindow,
        ImGuiDockNodeState_HostWindowHiddenBecauseWindowsAreResizing,
        ImGuiDockNodeState_HostWindowVisible,
    };
    using ImVector_ImGuiWindowPtr = struct ImVector_ImGuiWindowPtr {
        int Size;
        int Capacity;
        ImGuiWindow** Data;
    };
    ...
    using ImGuiWindowDockStyleCol = enum {
    ...
    using ImVector_ImGuiDockRequest = struct ImVector_ImGuiDockRequest {
        int Size;
        int Capacity;
        ImGuiDockRequest* Data;
    };

    using ImVector_ImGuiDockNodeSettings = struct ImVector_ImGuiDockNodeSettings {
        int Size;
        int Capacity;
    ...
    using ImGuiViewportP = struct ImGuiViewportP;
    ...
    using ImGuiDebugLogFlags_ = enum {
    ...
    using ImGuiDebugAllocEntry = struct ImGuiDebugAllocEntry;
    ...
    using ImGuiDebugAllocInfo = struct ImGuiDebugAllocInfo;
    ...
    using ImGuiStackLevelInfo = struct ImGuiStackLevelInfo;
    ...
    using ImGuiIDStackTool = struct ImGuiIDStackTool;
    using ImVector_ImGuiStackLevelInfo = struct ImVector_ImGuiStackLevelInfo {
        int Size;
        int Capacity;
    ...
    using ImGuiContextHookCallback = void (*)(ImGuiContext* ctx, ImGuiContextHook* hook);
    using ImGuiContextHookType = enum {
    ...
    using ImVector_ImGuiInputEvent = struct ImVector_ImGuiInputEvent {
        int Size;
        int Capacity;
        ImGuiInputEvent* Data;
    };

    using ImVector_ImGuiWindowStackData = struct ImVector_ImGuiWindowStackData {
        int Size;
        int Capacity;
        ImGuiWindowStackData* Data;
    };

    using ImVector_ImGuiColorMod = struct ImVector_ImGuiColorMod {
        int Size;
        int Capacity;
        ImGuiColorMod* Data;
    };

    using ImVector_ImGuiStyleMod = struct ImVector_ImGuiStyleMod {
        int Size;
        int Capacity;
        ImGuiStyleMod* Data;
    };

    using ImVector_ImGuiFocusScopeData = struct ImVector_ImGuiFocusScopeData {
        int Size;
        int Capacity;
        ImGuiFocusScopeData* Data;
    };

    using ImVector_ImGuiItemFlags = struct ImVector_ImGuiItemFlags {
        int Size;
        int Capacity;
        ImGuiItemFlags* Data;
    };

    using ImVector_ImGuiGroupData = struct ImVector_ImGuiGroupData {
        int Size;
        int Capacity;
        ImGuiGroupData* Data;
    };

    using ImVector_ImGuiPopupData = struct ImVector_ImGuiPopupData {
        int Size;
        int Capacity;
        ImGuiPopupData* Data;
    };

    using ImVector_ImGuiNavTreeNodeData = struct ImVector_ImGuiNavTreeNodeData {
        int Size;
        int Capacity;
        ImGuiNavTreeNodeData* Data;
    };

    using ImVector_ImGuiViewportPPtr = struct ImVector_ImGuiViewportPPtr {
        int Size;
        int Capacity;
        ImGuiViewportP** Data;
    };

    using ImVector_unsigned_char = struct ImVector_unsigned_char {
        int Size;
        int Capacity;
        unsigned char* Data;
    };

    using ImVector_ImGuiListClipperData = struct ImVector_ImGuiListClipperData {
        int Size;
        int Capacity;
        ImGuiListClipperData* Data;
    };

    using ImVector_ImGuiTableTempData = struct ImVector_ImGuiTableTempData {
        int Size;
        int Capacity;
        ImGuiTableTempData* Data;
    };

    using ImVector_ImGuiTable = struct ImVector_ImGuiTable {
        int Size;
        int Capacity;
        ImGuiTable* Data;
    };

    using ImPool_ImGuiTable = struct ImPool_ImGuiTable {
    ...
    using ImVector_ImGuiTabBar = struct ImVector_ImGuiTabBar {
        int Size;
        int Capacity;
        ImGuiTabBar* Data;
    };

    using ImPool_ImGuiTabBar = struct ImPool_ImGuiTabBar {
    ...
    using ImVector_ImGuiPtrOrIndex = struct ImVector_ImGuiPtrOrIndex {
        int Size;
        int Capacity;
        ImGuiPtrOrIndex* Data;
    };

    using ImVector_ImGuiShrinkWidthItem = struct ImVector_ImGuiShrinkWidthItem {
        int Size;
        int Capacity;
        ImGuiShrinkWidthItem* Data;
    };

    using ImVector_ImGuiID = struct ImVector_ImGuiID {
        int Size;
        int Capacity;
        ImGuiID* Data;
    };

    using ImVector_ImGuiSettingsHandler = struct ImVector_ImGuiSettingsHandler {
        int Size;
        int Capacity;
        ImGuiSettingsHandler* Data;
    };

    using ImChunkStream_ImGuiWindowSettings = struct ImChunkStream_ImGuiWindowSettings {
        ImVector_char Buf;
    };

    using ImChunkStream_ImGuiTableSettings = struct ImChunkStream_ImGuiTableSettings {
        ImVector_char Buf;
    };

    using ImVector_ImGuiContextHook = struct ImVector_ImGuiContextHook {
        int Size;
        int Capacity;
    ...
    using ImVector_ImGuiOldColumns = struct ImVector_ImGuiOldColumns {
        int Size;
        int Capacity;
    ...
    using ImGuiTabBarFlagsPrivate_ = enum {
        ImGuiTabBarFlags_DockNode = 1 << 20,
        ImGuiTabBarFlags_IsFocused = 1 << 21,
        ImGuiTabBarFlags_SaveSettings = 1 << 22,
    };
    using ImGuiTabItemFlagsPrivate_ = enum {
    ...
    using ImVector_ImGuiTabItem = struct ImVector_ImGuiTabItem {
        int Size;
        int Capacity;
        ImGuiTabItem* Data;
    };
    ...
    using ImGuiTableColumnIdx = ImS16;
    using ImGuiTableDrawChannelIdx = ImU16;
    ...
    using ImGuiTableCellData = struct ImGuiTableCellData;
    ...
    using ImSpan_ImGuiTableColumn = struct ImSpan_ImGuiTableColumn {
        ImGuiTableColumn* Data;
        ImGuiTableColumn* DataEnd;
    };

    using ImSpan_ImGuiTableColumnIdx = struct ImSpan_ImGuiTableColumnIdx {
        ImGuiTableColumnIdx* Data;
        ImGuiTableColumnIdx* DataEnd;
    };

    using ImSpan_ImGuiTableCellData = struct ImSpan_ImGuiTableCellData {
        ImGuiTableCellData* Data;
        ImGuiTableCellData* DataEnd;
    };

    using ImVector_ImGuiTableInstanceData = struct ImVector_ImGuiTableInstanceData {
        int Size;
        int Capacity;
        ImGuiTableInstanceData* Data;
    };

    using ImVector_ImGuiTableColumnSortSpecs = struct ImVector_ImGuiTableColumnSortSpecs {
        int Size;
        int Capacity;
    ...
    using ImVector_ImGuiTableHeaderData = struct ImVector_ImGuiTableHeaderData {
        int Size;
        int Capacity;
    ...
    using ImGuiTableColumnSettings = struct ImGuiTableColumnSettings;
...
#pragma endregion
    ...
    inline bool BeginChild(const char* str_id, const ImVec2 size = ImVec2(0, 0), ImGuiChildFlags child_flags = 0,
        ...
        using func_t = bool (*)(const char*, ImVec2, ImGuiChildFlags, ImGuiWindowFlags);
    ...
    inline bool BeginChild(ImGuiID id, const ImVec2 size = ImVec2(0, 0), ImGuiChildFlags child_flags = 0,
                           ImGuiWindowFlags window_flags = 0) {
        using func_t = bool (*)(ImGuiID, ImVec2, ImGuiChildFlags, ImGuiWindowFlags);
    ...
    inline void SetNextWindowPos(const ImVec2 pos, ImGuiCond cond, const ImVec2 pivot) {
        using func_t = void (*)(ImVec2, ImGuiCond, ImVec2);
    ...
    inline void SetNextWindowSize(const ImVec2 size, ImGuiCond cond = 0) {
        using func_t = void (*)(ImVec2, ImGuiCond);
    ...
    inline void SetNextWindowSizeConstraints(const ImVec2 size_min, const ImVec2 size_max,
        ...
        using func_t = void (*)(ImVec2, ImVec2, ImGuiSizeCallback, void*);
    ...
    inline void SetWindowPos(const char* name, const ImVec2 pos, ImGuiCond cond = 0) {
        using func_t = void (*)(const char*, ImVec2, ImGuiCond);
    ...
    inline void PushStyleColor(ImGuiCol idx, const ImVec4 col) {
        using func_t = void (*)(ImGuiCol, ImVec4);
    ...
    inline void PushStyleVar(ImGuiStyleVar idx, const ImVec2 val) {
        using func_t = void (*)(ImGuiStyleVar, ImVec2);
    ...
    inline void TextColored(const ImVec4 col, const char* fmt, ...) {
        using func_t = void (*)(ImVec4, const char*, va_list);
    ...
    inline bool Button(const char* label, const ImVec2 size = ImVec2(0, 0)) {
        using func_t = bool (*)(const char*, ImVec2);
    ...
    inline bool InvisibleButton(const char* str_id, const ImVec2 size, ImGuiButtonFlags flags = 0) {
        using func_t = bool (*)(const char*, ImVec2, ImGuiButtonFlags);
    ...
    inline void ProgressBar(float fraction, const ImVec2 size_arg, const char* overlay) {
        using func_t = void (*)(float, ImVec2, const char*);
    ...
    inline void Image(ImTextureID user_texture_id, const ImVec2 image_size, const ImVec2 uv0 = ImVec2(0, 0),
        ...
        using func_t = void (*)(ImTextureID, ImVec2, ImVec2, ImVec2, ImVec4, ImVec4);
    ...
    inline bool ImageButton(const char* str_id, ImTextureID user_texture_id, const ImVec2 image_size,
        ...
        using func_t = bool (*)(const char*, ImTextureID, ImVec2, ImVec2, ImVec2, ImVec4, ImVec4);
    ...
    inline bool VSliderFloat(const char* label, const ImVec2 size, float* v, float v_min, float v_max,
                             const char* format = "%.3f", ImGuiSliderFlags flags = 0) {
        using func_t = bool (*)(const char*, ImVec2, float*, float, float, const char*, ImGuiSliderFlags);
    ...
    inline bool VSliderInt(const char* label, const ImVec2 size, int* v, int v_min, int v_max,
                           const char* format = "%d", ImGuiSliderFlags flags = 0) {
        using func_t = bool (*)(const char*, ImVec2, int*, int, int, const char*, ImGuiSliderFlags);
    ...
    inline bool VSliderScalar(const char* label, const ImVec2 size, ImGuiDataType data_type, void* p_data,
                              ...
                              ImGuiSliderFlags flags = 0) {
        using func_t = bool (*)(const char*, ImVec2, ImGuiDataType, void*, const void*, const void*, const char*,
                                ImGuiSliderFlags);
    ...
    inline bool InputTextMultiline(const char* label, char* buf, size_t buf_size, const ImVec2 size,
        ...
        using func_t = bool (*)(const char*, char*, size_t, ImVec2, ImGuiInputTextFlags, ImGuiInputTextCallback, void*);
    ...
    inline bool ColorButton(const char* desc_id, const ImVec4 col, ImGuiColorEditFlags flags, const ImVec2 size) {
        using func_t = bool (*)(const char*, ImVec4, ImGuiColorEditFlags, ImVec2);
    ...
    inline bool Selectable(const char* label, bool selected, ImGuiSelectableFlags flags = 0,
        ...
        using func_t = bool (*)(const char*, bool, ImGuiSelectableFlags, ImVec2);
    ...
    inline bool BeginTable(const char* str_id, int column, ImGuiTableFlags flags = 0,
        ...
        using func_t = bool (*)(const char*, int, ImGuiTableFlags, ImVec2, float);
    ...
    inline ImGuiID DockSpace(ImGuiID dockspace_id, const ImVec2 size, ImGuiDockNodeFlags flags,
        ...
        using func_t = ImGuiID (*)(ImGuiID, ImVec2, ImGuiDockNodeFlags, const ImGuiWindowClass*);
    ...
    inline void PushClipRect(const ImVec2 clip_rect_min, const ImVec2 clip_rect_max,
        ...
        using func_t = void (*)(ImVec2, ImVec2, bool);
    ...
    inline bool IsRectVisible(const ImVec2 rect_min, const ImVec2 rect_max) {
        using func_t = bool (*)(ImVec2, ImVec2);
    ...
    inline bool IsMouseHoveringRect(const ImVec2 r_min, const ImVec2 r_max, bool clip = true) {
        using func_t = bool (*)(ImVec2, ImVec2, bool);
    ...
    namespace ImDrawListManager {
        ...
        inline void PushClipRect(ImDrawList* self, const ImVec2 clip_rect_min, const ImVec2 clip_rect_max,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, bool);
        ...
        inline void AddLine(ImDrawList* self, const ImVec2 p1, const ImVec2 p2, ImU32 col, float thickness) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImU32, float);
        ...
        inline void AddRect(ImDrawList* self, const ImVec2 p_min, const ImVec2 p_max, ImU32 col, float rounding,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImU32, float, ImDrawFlags, float);
        ...
        inline void AddRectFilled(ImDrawList* self, const ImVec2 p_min, const ImVec2 p_max, ImU32 col, float rounding,
                                  ImDrawFlags flags) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImU32, float, ImDrawFlags);
        ...
        inline void AddRectFilledMultiColor(ImDrawList* self, const ImVec2 p_min, const ImVec2 p_max,
                                            ...
                                            ImU32 col_bot_left) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImU32, ImU32, ImU32, ImU32);
        ...
        inline void AddQuad(ImDrawList* self, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImVec2, ImVec2, ImU32, float);
        ...
        inline void AddQuadFilled(ImDrawList* self, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4,
                                  ImU32 col) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImVec2, ImVec2, ImU32);
        ...
        inline void AddTriangle(ImDrawList* self, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, ImU32 col,
                                float thickness) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImVec2, ImU32, float);
        ...
        inline void AddTriangleFilled(ImDrawList* self, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, ImU32 col) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImVec2, ImU32);
        ...
        inline void AddCircle(ImDrawList* self, const ImVec2 center, float radius, ImU32 col, int num_segments,
                              float thickness) {
            using func_t = void (*)(ImDrawList*, ImVec2, float, ImU32, int, float);
        ...
        inline void AddCircleFilled(ImDrawList* self, const ImVec2 center, float radius, ImU32 col, int num_segments) {
            using func_t = void (*)(ImDrawList*, ImVec2, float, ImU32, int);
        ...
        inline void AddEllipse(ImDrawList* self, const ImVec2 center, const ImVec2 radius, ImU32 col, float rot,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImU32, float, int, float);
        ...
        inline void AddEllipseFilled(ImDrawList* self, const ImVec2 center, const ImVec2 radius, ImU32 col, float rot,
                                     int num_segments) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImU32, float, int);
        ...
        inline void AddText(ImDrawList* self, const ImVec2 pos, ImU32 col, const char* text_begin,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, ImU32, const char*, const char*);
        ...
        inline void AddText(ImDrawList* self, const ImFont* font, float font_size, const ImVec2 pos, ImU32 col,
                            const char* text_begin, const char* text_end = nullptr, float wrap_width = 0.0f,
                            const ImVec4* cpu_fine_clip_rect = nullptr) {
            using func_t = void (*)(ImDrawList*, const ImFont*, float, ImVec2, ImU32, const char*, const char*, float,
                                    const ImVec4*);
        ...
        inline void AddBezierCubic(ImDrawList* self, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImVec2, ImVec2, ImU32, float, int);
        ...
        inline void AddBezierQuadratic(ImDrawList* self, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, ImU32 col,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImVec2, ImU32, float, int);
        ...
        inline void AddImage(ImDrawList* self, ImTextureID user_texture_id, const ImVec2 p_min, const ImVec2 p_max,
            ...
            using func_t = void (*)(ImDrawList*, ImTextureID, ImVec2, ImVec2, ImVec2, ImVec2, ImU32);
        ...
        inline void AddImageQuad(ImDrawList* self, ImTextureID user_texture_id, const ImVec2 p1, const ImVec2 p2,
            ...
            using func_t = void (*)(ImDrawList*, ImTextureID, ImVec2, ImVec2, ImVec2, ImVec2, ImVec2, ImVec2, ImVec2,
                                    ImVec2, ImU32);
        ...
        inline void AddImageRounded(ImDrawList* self, ImTextureID user_texture_id, const ImVec2 p_min,
            ...
            using func_t =
                void (*)(ImDrawList*, ImTextureID, ImVec2, ImVec2, ImVec2, ImVec2, ImU32, float, ImDrawFlags);
        ...
        inline void PathLineTo(ImDrawList* self, const ImVec2 pos) {
            using func_t = void (*)(ImDrawList*, ImVec2);
        ...
        inline void PathArcTo(ImDrawList* self, const ImVec2 center, float radius, float a_min, float a_max,
                              int num_segments) {
            using func_t = void (*)(ImDrawList*, ImVec2, float, float, float, int);
        ...
        inline void PathArcToFast(ImDrawList* self, const ImVec2 center, float radius, int a_min_of_12,
                                  int a_max_of_12) {
            using func_t = void (*)(ImDrawList*, ImVec2, float, int, int);
        ...
        inline void PathEllipticalArcTo(ImDrawList* self, const ImVec2 center, const ImVec2 radius, float rot,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, float, float, float, int);
        ...
        inline void PathBezierCubicCurveTo(ImDrawList* self, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4,
                                           int num_segments) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImVec2, int);
        ...
        inline void PathBezierQuadraticCurveTo(ImDrawList* self, const ImVec2 p2, const ImVec2 p3, int num_segments) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, int);
            func_t func =
        ...
        inline void PathRect(ImDrawList* self, const ImVec2 rect_min, const ImVec2 rect_max, float rounding,
                             ImDrawFlags flags) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, float, ImDrawFlags);
        ...
        inline void PrimRect(ImDrawList* self, const ImVec2 a, const ImVec2 b, ImU32 col) {
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImU32);
        ...
        inline void PrimQuadUV(ImDrawList* self, const ImVec2 a, const ImVec2 b, const ImVec2 c, const ImVec2 d,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, ImVec2, ImVec2, ImVec2, ImVec2, ImVec2, ImVec2, ImU32);
        ...
        inline void _PathArcToFastEx(ImDrawList* self, const ImVec2 center, float radius, int a_min_sample,
            ...
            using func_t = void (*)(ImDrawList*, ImVec2, float, int, int, int);
    ...
    namespace ImDrawDataManager {
        ...
        inline void ScaleClipRects(ImDrawData* self, const ImVec2 fb_scale) {
            using func_t = void (*)(ImDrawData*, ImVec2);
    ...
    namespace ImFontAtlasManager {
        ...
        inline int AddCustomRectFontGlyph(ImFontAtlas* self, ImFont* font, ImWchar id, int width, int height,
            ...
            using func_t = int (*)(ImFontAtlas*, ImFont*, ImWchar, int, int, float, ImVec2);
    ...
    namespace ImFontManger {
        ...
        inline void RenderChar(ImFont* self, ImDrawList* draw_list, float size, const ImVec2 pos, ImU32 col,
                               ImWchar c) {
            using func_t = void (*)(ImFont*, ImDrawList*, float, ImVec2, ImU32, ImWchar);
        ...
        inline void RenderText(ImFont* self, ImDrawList* draw_list, float size, const ImVec2 pos, ImU32 col,
                               ...
                               bool cpu_fine_clip) {
            using func_t =
                void (*)(ImFont*, ImDrawList*, float, ImVec2, ImU32, ImVec4, const char*, const char*, float, bool);
    ...
    inline void ImQsort(void* base, size_t count, size_t size_of_element,
        ...
        using func_t = void (*)(void*, size_t, size_t, int (*)(const void*, const void*));
    ...
    inline void ImMin(ImVec2* pOut, const ImVec2 lhs, const ImVec2 rhs) {
        using func_t = void (*)(ImVec2*, ImVec2, ImVec2);
    ...
    inline void ImClamp(ImVec2* pOut, const ImVec2 v, const ImVec2 mn, const ImVec2 mx) {
        using func_t = void (*)(ImVec2*, ImVec2, ImVec2, ImVec2);
    ...
    inline void ImLerp(ImVec2* pOut, const ImVec2 a, const ImVec2 b, float t) {
        using func_t = void (*)(ImVec2*, ImVec2, ImVec2, float);
    ...
    inline void ImLerp(ImVec4* pOut, const ImVec4 a, const ImVec4 b, float t) {
        using func_t = void (*)(ImVec4*, ImVec4, ImVec4, float);
    ...
    inline float ImInvLength(const ImVec2 lhs, float fail_value) {
        using func_t = float (*)(ImVec2, float);
    ...
    inline void ImTrunc(ImVec2* pOut, const ImVec2 v) {
        using func_t = void (*)(ImVec2*, ImVec2);
    ...
    inline float ImDot(const ImVec2 a, const ImVec2 b) {
        using func_t = float (*)(ImVec2, ImVec2);
    ...
    inline void ImBezierCubicCalc(ImVec2* pOut, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, const ImVec2 p4,
                                  float t) {
        using func_t = void (*)(ImVec2*, ImVec2, ImVec2, ImVec2, ImVec2, float);
    ...
    inline void ImBezierCubicClosestPoint(ImVec2* pOut, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3,
        ...
        using func_t = void (*)(ImVec2*, ImVec2, ImVec2, ImVec2, ImVec2, ImVec2, int);
    ...
    inline void ImBezierCubicClosestPointCasteljau(ImVec2* pOut, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3,
        ...
        using func_t = void (*)(ImVec2*, ImVec2, ImVec2, ImVec2, ImVec2, ImVec2, float);
    ...
    inline void ImBezierQuadraticCalc(ImVec2* pOut, const ImVec2 p1, const ImVec2 p2, const ImVec2 p3, float t) {
        using func_t = void (*)(ImVec2*, ImVec2, ImVec2, ImVec2, float);
    ...
    inline bool ImTriangleContainsPoint(const ImVec2 a, const ImVec2 b, const ImVec2 c, const ImVec2 p) {
        using func_t = bool (*)(ImVec2, ImVec2, ImVec2, ImVec2);
    ...
    inline void ImTriangleClosestPoint(ImVec2* pOut, const ImVec2 a, const ImVec2 b, const ImVec2 c, const ImVec2 p) {
        using func_t = void (*)(ImVec2*, ImVec2, ImVec2, ImVec2, ImVec2);
    ...
    inline void ImTriangleBarycentricCoords(const ImVec2 a, const ImVec2 b, const ImVec2 c, const ImVec2 p,
        ...
        using func_t = void (*)(ImVec2, ImVec2, ImVec2, ImVec2, float*, float*, float*);
    ...
    inline float ImTriangleArea(const ImVec2 a, const ImVec2 b, const ImVec2 c) {
        using func_t = float (*)(ImVec2, ImVec2, ImVec2);
    ...
    inline bool ImTriangleIsClockwise(const ImVec2 a, const ImVec2 b, const ImVec2 c) {
        using func_t = bool (*)(ImVec2, ImVec2, ImVec2);
    ...
    namespace ImRectManager {
        ...
        inline ImRect* ImRect_Vec2(const ImVec2 min, const ImVec2 max) {
            using func_t = ImRect* (*)(ImVec2, ImVec2);
        ...
        inline bool Contains_Vec2(ImRect* self, const ImVec2 p) {
            using func_t = bool (*)(ImRect*, ImVec2);
        ...
        inline bool Contains_Rect(ImRect* self, const ImRect r) {
            using func_t = bool (*)(ImRect*, ImRect);
        ...
        inline bool ContainsWithPad(ImRect* self, const ImVec2 p, const ImVec2 pad) {
            using func_t = bool (*)(ImRect*, ImVec2, ImVec2);
        ...
        inline void Add_Vec2(ImRect* self, const ImVec2 p) {
            using func_t = void (*)(ImRect*, ImVec2);
        ...
        inline void Add_Rect(ImRect* self, const ImRect r) {
            using func_t = void (*)(ImRect*, ImRect);
    ...
    namespace ImGuiViewportPManager {
        ...
        inline void CalcWorkRectPos(ImVec2* pOut, ImGuiViewportP* self, const ImVec2 off_min) {
            using func_t = void (*)(ImVec2*, ImGuiViewportP*, ImVec2);
        ...
        inline void CalcWorkRectSize(ImVec2* pOut, ImGuiViewportP* self, const ImVec2 off_min, const ImVec2 off_max) {
            using func_t = void (*)(ImVec2*, ImGuiViewportP*, ImVec2, ImVec2);
    ...
    namespace ImGuiWindowManager {
        ...
        inline ImGuiID GetIDFromRectangle(ImGuiWindow* self, const ImRect r_abs) {
            using func_t = ImGuiID (*)(ImGuiWindow*, ImRect);
    ...
    inline void SetWindowPos(ImGuiWindow* window, const ImVec2 pos, ImGuiCond cond) {
        using func_t = void (*)(ImGuiWindow*, ImVec2, ImGuiCond);
    ...
    inline void SetWindowHitTestHole(ImGuiWindow* window, const ImVec2 pos, const ImVec2 size) {
        using func_t = void (*)(ImGuiWindow*, ImVec2, ImVec2);
    ...
    inline void WindowRectAbsToRel(ImRect* pOut, ImGuiWindow* window, const ImRect r) {
        using func_t = void (*)(ImRect*, ImGuiWindow*, ImRect);
    ...
    inline void WindowPosRelToAbs(ImVec2* pOut, ImGuiWindow* window, const ImVec2 p) {
        using func_t = void (*)(ImVec2*, ImGuiWindow*, ImVec2);
    ...
    inline void FindHoveredWindowEx(const ImVec2 pos, bool find_first_and_in_any_viewport,
        ...
        using func_t = void (*)(ImVec2, bool, ImGuiWindow**, ImGuiWindow**);
    ...
    inline void TranslateWindowsInViewport(ImGuiViewportP* viewport, const ImVec2 old_pos, const ImVec2 new_pos) {
        using func_t = void (*)(ImGuiViewportP*, ImVec2, ImVec2);
    ...
    inline ImGuiViewportP* FindHoveredViewportFromPlatformWindowStack(const ImVec2 mouse_platform_pos) {
        using func_t = ImGuiViewportP* (*)(ImVec2);
        func_t func =
    ...
    inline void ScrollToRect(ImGuiWindow* window, const ImRect rect, ImGuiScrollFlags flags) {
        using func_t = void (*)(ImGuiWindow*, ImRect, ImGuiScrollFlags);
    ...
    inline void ScrollToRectEx(ImVec2* pOut, ImGuiWindow* window, const ImRect rect, ImGuiScrollFlags flags) {
        using func_t = void (*)(ImVec2*, ImGuiWindow*, ImRect, ImGuiScrollFlags);
    ...
    inline void ScrollToBringRectIntoView(ImGuiWindow* window, const ImRect rect) {
        using func_t = void (*)(ImGuiWindow*, ImRect);
    ...
    inline void ItemSize(const ImVec2 size, float text_baseline_y) {
        using func_t = void (*)(ImVec2, float);
    ...
    inline bool ItemAdd(const ImRect bb, ImGuiID id, const ImRect* nav_bb, ImGuiItemFlags extra_flags) {
        using func_t = bool (*)(ImRect, ImGuiID, const ImRect*, ImGuiItemFlags);
    ...
    inline bool ItemHoverable(const ImRect bb, ImGuiID id, ImGuiItemFlags item_flags) {
        using func_t = bool (*)(ImRect, ImGuiID, ImGuiItemFlags);
    ...
    inline bool IsClippedEx(const ImRect bb, ImGuiID id) {
        using func_t = bool (*)(ImRect, ImGuiID);
    ...
    inline void SetLastItemData(ImGuiID item_id, ImGuiItemFlags in_flags, ImGuiItemStatusFlags status_flags,
        ...
        using func_t = void (*)(ImGuiID, ImGuiItemFlags, ImGuiItemStatusFlags, ImRect);
    ...
    inline bool BeginChildEx(const char* name, ImGuiID id, const ImVec2 size_arg, ImGuiChildFlags child_flags,
        ...
        using func_t = bool (*)(const char*, ImGuiID, ImVec2, ImGuiChildFlags, ImGuiWindowFlags);
    ...
    inline void FindBestWindowPosForPopupEx(ImVec2* pOut, const ImVec2 ref_pos, const ImVec2 size, ImGuiDir* last_dir,
        ...
        using func_t = void (*)(ImVec2*, ImVec2, ImVec2, ImGuiDir*, ImRect, ImRect, ImGuiPopupPositionPolicy);
    ...
    inline bool BeginComboPopup(ImGuiID popup_id, const ImRect bb, ImGuiComboFlags flags) {
        using func_t = bool (*)(ImGuiID, ImRect, ImGuiComboFlags);
    ...
    inline void SetNavID(ImGuiID id, ImGuiNavLayer nav_layer, ImGuiID focus_scope_id, const ImRect rect_rel) {
        using func_t = void (*)(ImGuiID, ImGuiNavLayer, ImGuiID, ImRect);
    ...
    inline bool BeginTableEx(const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags,
        ...
        using func_t = bool (*)(const char*, ImGuiID, int, ImGuiTableFlags, ImVec2, float);
    ...
    inline bool BeginTabBarEx(ImGuiTabBar* tab_bar, const ImRect bb, ImGuiTabBarFlags flags) {
        using func_t = bool (*)(ImGuiTabBar*, ImRect, ImGuiTabBarFlags);
    ...
    inline void TabItemBackground(ImDrawList* draw_list, const ImRect bb, ImGuiTabItemFlags flags, ImU32 col) {
        using func_t = void (*)(ImDrawList*, ImRect, ImGuiTabItemFlags, ImU32);
    ...
    inline void TabItemLabelAndCloseButton(ImDrawList* draw_list, const ImRect bb, ImGuiTabItemFlags flags,
        ...
        using func_t =
            void (*)(ImDrawList*, ImRect, ImGuiTabItemFlags, ImVec2, const char*, ImGuiID, ImGuiID, bool, bool*, bool*);
    ...
    inline void RenderTextClipped(const ImVec2 pos_min, const ImVec2 pos_max, const char* text, const char* text_end,
        ...
        using func_t = void (*)(ImVec2, ImVec2, const char*, const char*, const ImVec2*, ImVec2, const ImRect*);
    ...
    inline void RenderTextClippedEx(ImDrawList* draw_list, const ImVec2 pos_min, const ImVec2 pos_max, const char* text,
        ...
        using func_t =
            void (*)(ImDrawList*, ImVec2, ImVec2, const char*, const char*, const ImVec2*, ImVec2, const ImRect*);
    ...
    inline void RenderTextEllipsis(ImDrawList* draw_list, const ImVec2 pos_min, const ImVec2 pos_max, float clip_max_x,
        ...
        using func_t = void (*)(ImDrawList*, ImVec2, ImVec2, float, float, const char*, const char*, const ImVec2*);
    ...
    inline void RenderNavHighlight(const ImRect bb, ImGuiID id, ImGuiNavHighlightFlags flags) {
        using func_t = void (*)(ImRect, ImGuiID, ImGuiNavHighlightFlags);
    ...
    inline void RenderRectFilledRangeH(ImDrawList* draw_list, const ImRect rect, ImU32 col, float x_start_norm,
        ...
        using func_t = void (*)(ImDrawList*, ImRect, ImU32, float, float, float);
    ...
    inline void RenderRectFilledWithHole(ImDrawList* draw_list, const ImRect outer, const ImRect inner, ImU32 col,
                                         float rounding) {
        using func_t = void (*)(ImDrawList*, ImRect, ImRect, ImU32, float);
    ...
    inline ImDrawFlags CalcRoundingFlagsForRectInRect(const ImRect r_in, const ImRect r_outer, float threshold) {
        using func_t = ImDrawFlags (*)(ImRect, ImRect, float);
    ...
    inline bool ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2 image_size, const ImVec2 uv0,
        ...
        using func_t = bool (*)(ImGuiID, ImTextureID, ImVec2, ImVec2, ImVec2, ImVec4, ImVec4, ImGuiButtonFlags);
    ...
    inline bool CloseButton(ImGuiID id, const ImVec2 pos) {
        using func_t = bool (*)(ImGuiID, ImVec2);
    ...
    inline bool CollapseButton(ImGuiID id, const ImVec2 pos, ImGuiDockNode* dock_node) {
        using func_t = bool (*)(ImGuiID, ImVec2, ImGuiDockNode*);
    ...
    inline bool ScrollbarEx(const ImRect bb, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 avail_v,
        ...
        using func_t = bool (*)(ImRect, ImGuiID, ImGuiAxis, ImS64*, ImS64, ImS64, ImDrawFlags);
    ...
    inline bool ButtonBehavior(const ImRect bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags) {
        using func_t = bool (*)(ImRect, ImGuiID, bool*, bool*, ImGuiButtonFlags);
    ...
    inline bool SliderBehavior(const ImRect bb, ImGuiID id, ImGuiDataType data_type, void* p_v, const void* p_min,
        ...
        using func_t = bool (*)(ImRect, ImGuiID, ImGuiDataType, void*, const void*, const void*, const char*,
    ...
    inline bool SplitterBehavior(const ImRect bb, ImGuiID id, ImGuiAxis axis, float* size1, float* size2,
                                 ...
                                 ImU32 bg_col) {
        using func_t = bool (*)(ImRect, ImGuiID, ImGuiAxis, float*, float*, float, float, float, float, ImU32);
    ...
    inline bool InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2 size_arg,
                            ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data) {
        using func_t =
            bool (*)(const char*, const char*, char*, int, ImVec2, ImGuiInputTextFlags, ImGuiInputTextCallback, void*);
    ...
    inline bool TempInputText(const ImRect bb, ImGuiID id, const char* label, char* buf, int buf_size,
                              ImGuiInputTextFlags flags) {
        using func_t = bool (*)(ImRect, ImGuiID, const char*, char*, int, ImGuiInputTextFlags);
    ...
    inline bool TempInputScalar(const ImRect bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data,
        ...
        using func_t =
            bool (*)(ImRect, ImGuiID, const char*, ImGuiDataType, void*, const char*, const void*, const void*);
    ...
    inline void ShadeVertsLinearUV(ImDrawList* draw_list, int vert_start_idx, int vert_end_idx, const ImVec2 a,
        ...
        using func_t = void (*)(ImDrawList*, int, int, ImVec2, ImVec2, ImVec2, ImVec2, bool);
    ...
    inline void ShadeVertsTransformPos(ImDrawList* draw_list, int vert_start_idx, int vert_end_idx,
        ...
        using func_t = void (*)(ImDrawList*, int, int, ImVec2, float, float, ImVec2);
    ...
    inline void DebugRenderViewportThumbnail(ImDrawList* draw_list, ImGuiViewportP* viewport, const ImRect bb) {
        using func_t = void (*)(ImDrawList*, ImGuiViewportP*, ImRect);
